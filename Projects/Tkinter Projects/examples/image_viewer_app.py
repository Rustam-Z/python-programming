...
# Images location
img1 = ImageTk.PhotoImage(Image.open("photos/python.png"))
img2 = ImageTk.PhotoImage(Image.open("photos/python-file.png"))
img3 = ImageTk.PhotoImage(Image.open("photos/python-file-1.png"))
