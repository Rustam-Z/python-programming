...
class MenuBar(tk.Menu):
    ...
    def dict_search(self):
        ...
        self.list_box = tk.Listbox(self.frame2, yscrollcommand=scrollbar.set, width=50, height=50, borderwidth=0,
    ...
    def bookmarks(self):
        ...
        p2 = ttk.Label(self.bookmarks_frame, text="Here you can find your bookmarks")
        ...
        self.list_box_1 = tk.Listbox(self.bookmarks_frame, yscrollcommand=scrollbar.set, width=50, height=50,
        ...
        self.list_box_1.bind("<<ListboxSelect>>", self.from_bookmarks)
        scrollbar.config(command=self.list_box_1.yview)

    def bookmark_it(self):
        if self.var.get() == 1:
    ...
    def info_about(self):
        ...
        ttk.Label(self.info_about_frame, text="EightSoft | Rustam-Z | Alimov-8").pack()

        link1 = tk.Label(self.info_about_frame, text="Source Code", fg='#215fdb')
        link1.pack()
        link1.bind("<Button-1>",
                   lambda e: callback("https://github.com/Rustam-Z/learning-area/tree/master/app1_dictionary")
                   )
